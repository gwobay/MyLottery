...
public class Check23Filter4DropNt extends JFrame implements Runnable 
{
/**
		...
		for (int idx=testStartIndex; idx<=testLastIndex; idx++){
			...
			//System.out.println("Working on "+lineType);
				for (int i=0; i<dd.length; i++){
					...
					int[] predictions=Check23Filter4DropNt.tryNewSample(testData);
...
public static void main(String[] args)
{
	...
	Vector<int[]> sampleData=jReaderOrder.readData(5, 39, 390);	
		...
		System.out.println("Data List has "+iLen1+" samples");
		...
		Check23Filter4DropNt aCharter=new Check23Filter4DropNt();
