...
public class Data1Case23 extends JFrame implements Runnable 
{
/**
...
public static void main(String[] args)
{
	...
	Vector<int[]> sampleData=jReaderOrder.readData(5, 39, 390);//72);//390);	
		globalSample=sampleData;
		
		Data1Case23 aJob=new Data1Case23();
		Data1Case23.fileBase="C:\\Users\\eric\\workspace\\GetLottery\\539\\measured\\";
			File myDir=new File(Data1Case23.fileBase);
			if (!myDir.exists()) myDir.mkdir();
			
			//DataAutocorrelation.fileBase="C:\\Users\\eric\\workspace\\GetLottery\\539\\";
			Vector<double[]> atf=Data1Case23.measuredAutoCorrelation(sampleData);
		...
		try {
			testLog=new BufferedWriter(new OutputStreamWriter(new FileOutputStream("try23Filter"+JackpotReader.drawDate+"Log1.txt")));	
				...
				//System.out.println("Working on "+lineType);
						...
						for (int i=0; i<dd.length; i++){
							...
							int[] predictions=//refineFound(dateAscend, "filterN"+(sqz*10)+lineType);//filterOutSample(dateAscend);;//
									tryNewSample(dateAscend);//dateAscend, "for"+JackpotReader.drawDate+"filterN"+(sqz*10)+lineType);
