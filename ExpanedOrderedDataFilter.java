...
public class ExpanedOrderedDataFilter extends JFrame implements Runnable 
{
/**
		...
		// while (diff2>0.1 && expandFactor<7 && !bFound)
		 //{ 
			...
			// double nRatio=ratio*(1+rdt);
			 iTry++;
			 //System.out.println("Line "+s+" use ratio "+nRatio);
			 for (int n4=1+s; n4<36+s && !bFound; n4 ++){//n4++){
				 newData[38]=n4;			 
...
public static void main(String[] args)
{
	...
	Vector<int[]> sampleData=jReaderOrder.readData(5, 39, 390);	
		...
		ExpanedOrderedDataFilter aJob=new ExpanedOrderedDataFilter();
