...
public class GetHistoryPrimeDataNew extends JFrame implements Runnable 
{
/**
	...
	for (int s=0; s<5; s++){
		...
		for (int i=0; i<loc.length; i++){
			...
			for (int k=0; k<onRange; k++){
				mean += (prime1.get(s)[loc[i]+k] - home[k]);
			}
			mean /= onRange;
...
{	
	...
	Vector<int[]> sampleData=jReaderOrder.readData(5, 39, 390);//jReaderDrop.readData(5, 39, 330);	//
		globalSample=sampleData;
			...
			int maxRange=18;
			int[] vHitCountByRange=new int[19];
			Arrays.fill(vHitCountByRange, 0);
			int[] pHitCountByRange=new int[19];
...
public static void main(String[] args)
{
	...
	Vector<int[]> sampleData=jReaderOrder.readData(5, 39, 390);//jReaderDrop.readData(5, 39, 330);	//
		...
		GetHistoryPrimeDataNew aCharter=new GetHistoryPrimeDataNew();
		...
		*/
		...
		Vector<double[]> atf=measured.measuredAutoCorrelation(sampleData);
			...
			//for (int i=0; i<5; i++){
				measured.putList2File(atf, "auto_lineM",
					globalSample);
			//}
