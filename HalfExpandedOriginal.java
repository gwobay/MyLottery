...
public class HalfExpandedOriginal extends JFrame implements Runnable 
{
/**
...
public static void main(String[] args)
{
	...
	Vector<int[]> sampleData=jReaderOrder.readData(5, 39, 512);	
		...
		HalfExpandedOriginal aJob=new HalfExpandedOriginal();
		...
		try {
			...
			//			
			int[][][] localPerformanceList=new int[fitMethods.length][6][6*39];
			...
			int[][][] predictionTS=new int[fitMethods.length][234+1][];
		...
		for (int iTest=6*39; iTest >=0; iTest--){
			...
			for (int iMd=0; iMd<fitMethods.length; iMd++){
				...
				predictionTS[iMd][234-iTest]=pList;
				ttHits[iMd] += iFound;
			...
			if (iTest>0)
				localPerformanceList[iMd][iFound][6*39-iTest]=1;
		}
		}
