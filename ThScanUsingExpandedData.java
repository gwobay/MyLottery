...
public class ThScanUsingExpandedData extends JFrame implements Runnable 
{
/**
...
public static void main(String[] args)
{
	...
	Vector<int[]> sampleData=jReaderOrder.readData(5, 39, 612);	
		...
		ThScanUsingExpandedData aJob=new ThScanUsingExpandedData();
		...
		int[] freqs={8, 12, 16};//,4,8};//2, 3, 4, 5, 6};
		BufferedWriter testLog=null;
		String fileName="expandThP1"+lineType+JackpotReader.todayDrawID+"Scan.txt";//drawDate+"Scan.txt";
		try {
