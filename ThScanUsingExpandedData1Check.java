...
public class ThScanUsingExpandedData1Check extends JFrame implements Runnable 
{
/**
		 ...
		 for (int n4=1+s; n4<36+s; n4 += 36){//n4++){
			 ...
			 */
			 ...
			 for (int ix=0; ix<1; ix++){//checkCount1; ix++){
				 int i=checkLen-1;//ix+36-checkCount1;
				 pos=i*expandFactor;
				 double conv=0;
...
public static void main(String[] args)
{
	...
	Vector<int[]> sampleData=jReaderOrder.readData(5, 39, 612);	
		...
		ThScanUsingExpandedData1Check aJob=new ThScanUsingExpandedData1Check();
