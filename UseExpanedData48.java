...
public class UseExpanedData48 extends JFrame implements Runnable 
{
/**
...
public static void main(String[] args)
{
	...
	Vector<int[]> sampleData=jReaderOrder.readData(5, 39, 390);	
		...
		UseExpanedData48 aJob=new UseExpanedData48();
		...
		try {
			...
			new FileOutputStream("expand"+lineType+JackpotReader.drawDate+"48.txt")));	
			
			double avgCandidates=0;
			int[] iStatistics=new int[6];
			Arrays.fill(iStatistics, 0);
			int[] lastHitLoc=new int[6];
			Arrays.fill(lastHitLoc, 0);
		...
		iStatistics[iFound]++;
		int atLoc=iCheckEnd-iCheckStart;
		if (atLoc > 0)
			lastHitLoc[iFound]=atLoc;
		cTryCase++;
		iCheckStart++;
	}
	String statText="try "+cTryCase+" cases and got ";
	for (int p=1; p<6; p++){
		testLog.write( ""+p+":"+iStatistics[p]+"@"+lastHitLoc[p]);testLog.newLine();
	}
