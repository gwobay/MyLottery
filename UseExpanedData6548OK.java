...
public class UseExpanedData6548OK extends JFrame implements Runnable 
{
/**
	
	 */
	static String programName="UseExpanedData6548OK";
...
public static void main(String[] args)
{
	...
	Vector<int[]> sampleData=jReaderOrder.readData(5, 39, 512);	
		...
		UseExpanedData6548OK aJob=new UseExpanedData6548OK();
		...
		try {
			...
			new FileOutputStream("expand"+lineType+JackpotReader.drawDate+"6548Mon.txt")));	
		...
		for (int iFq=0; iFq<freqs.length; iFq++){
			...
			testLog.newLine();
	for (int p=0; p<6; p++){
		testLog.write(""+p+":"+iStatistics[iFq][p]+" @"+lastHitLocation[iFq][p]);testLog.newLine();
	}
		}
