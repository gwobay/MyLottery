...
public class UseExpanedDataMath extends JFrame implements Runnable 
{
/**
...
public static void main(String[] args)
{
	...
	Vector<int[]> sampleData=jReaderOrder.readData(5, 39, 390);	
		...
		UseExpanedDataMath aJob=new UseExpanedDataMath();
		...
		try {
			...
			new FileOutputStream("expand"+lineType+JackpotReader.drawDate+freqs[0]+"-"+ccVal[0]+"Mon.txt")));	
