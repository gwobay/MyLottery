...
public class GetYahooQuotes //read multiple mkts quote and create the chart for html all day long
{
...
String myQuotesUrl = "https://tw.finance.yahoo.com";//"https://tw.stock.yahoo.com";
	...
	QuoteReader aReader=new QuoteReader("*", myQuotesUrl, pgStartRead, pgEnd);
			...
			HashMap<String, Integer> volMax=new HashMap<String, Integer>();				volMax.put("OTC", new Integer(200000));			volMax.put("FIN", new Integer(100000));			aReader.setVolMax(volMax);
